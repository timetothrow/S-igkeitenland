...
class MinecraftShape:
    ...
    def draw(self):
        ...
        for blockToDraw in currentCounter - drawnCounter:
            self.mc.setBlock(blockToDraw.actualPos.x, blockToDraw.actualPos.y, blockToDraw.actualPos.z,
                             blockToDraw.blockType, blockToDraw.blockData)
    ...
    def move(self, x, y, z):
        ...
        # re-calculate the shapeBlockPositions based on the shapeBlocks and the position
